      ...
      <section className="bg-white border border-gray-200 rounded-2xl p-6 mb-6">
        ...
        <div className="relative h-32 rounded-xl overflow-hidden bg-gradient-to-br from-gray-700 to-gray-900 mb-4 group">
          ...
          <button
            ...
            className="absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 flex items-center justify-center text-white text-sm font-medium transition-opacity"
          >
        ...
        <div className="flex items-center gap-4">
          <div className="relative group">
            ...
            <button
              ...
              className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 rounded-full flex items-center justify-center text-white transition-opacity"
            >
          ...
          <div>
            ...
            <p className="text-gray-400 text-xs mt-1">Hover an image to change it</p>
          </div>
        </div>
      </section>
